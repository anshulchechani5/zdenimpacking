		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Denim Packing",
									"targetURL": "#PPzdenimpacking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PPzdenimpacking-display": {
								"semanticObject": "PPzdenimpacking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=PP.zdenimpacking",
									"url": sap.ui.require.toUrl("PP/zdenimpacking")
								}
							}
						}
					}
